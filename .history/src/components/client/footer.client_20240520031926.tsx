...
import styles from "styles/Footer.module.scss"; // Nhớ cập nhật đường dẫn chính xác
        ...
        >
            ...
            <div className={'$styles["footer-logo"]'}>
              ...
              >
                ...
                >
                  ...
                  >
                    <svg
                      className={`${styles["feather-icon"]} ${styles["icon-md"]}`}
                    >
                      <use href="https://itviec.com/assets/feather-icons-sprite-520cd3770a1002f7c87bd1ba253464228ad112abb4c34d81c8cda9f937487a49.svg#linkedin"></use>
                    </svg>
                  </div>
                </a>
                <a
                ...
                >
                  ...
                  >
                    <svg
                      className={`${styles["feather-icon"]} ${styles["icon-md"]}`}
                    >
                      <use href="https://itviec.com/assets/feather-icons-sprite-520cd3770a1002f7c87bd1ba253464228ad112abb4c34d81c8cda9f937487a49.svg#youtube"></use>
                    </svg>
                  </div>
                </a>
              </div>
          ...
          >
            ...
            >
              ...
              >
                <span>
                  <a data-controller="utm-tracking" href="/vi">
                    Trang Chủ
                  </a>
                </span>
                <span>
          ...
          <div
            className={`${styles["col-12"]} ${styles["col-lg-3"]} ${styles["p-0"]} `}
          >
            <h4
            ...
            >
              ...
              >
                ...
                >
                  <use href="https://itviec.com/assets/feather-icons-sprite-520cd3770a1002f7c87bd1ba253464228ad112abb4c34d81c8cda9f937487a49.svg#phone-call"></use>
                </svg>
              ...
              >
                <svg
                  className={`${styles["feather-icon"]} ${styles["icon-sm"]}`}
                >
                  <use href="https://itviec.com/assets/feather-icons-sprite-520cd3770a1002f7c87bd1ba253464228ad112abb4c34d81c8cda9f937487a49.svg#mail"></use>
                </svg>
                <p className={`${styles["ims-2"]}`}>Email: love@itviec.com</p>
              </div>
              <div
              ...
              >
                <svg
                  className={`${styles["feather-icon"]} ${styles["icon-sm"]}`}
                >
                  <use href="https://itviec.com/assets/feather-icons-sprite-520cd3770a1002f7c87bd1ba253464228ad112abb4c34d81c8cda9f937487a49.svg#send"></use>
                </svg>
                <p className={`${styles["ims-2"]}`}>
