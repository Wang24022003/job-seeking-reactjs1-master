...
const SearchClient = (props: any) => {
  ...
  return (
    <div style={{ background: "linear-gradient(90deg, rgba(0,0,0,1) 35%, rgba(121,9,9,1) 75%, rgba(255,0,0,1) 100%)", padding: "95px", marginLeft:"-110px", marginRight: "-110px" }}>
    <ProForm
      form={form}
      onFinish={onFinish}
      submitter={{
    ...
    >
      <Row gutter={[20, 20]}>
        <Col span={24}>
          <h2 style={{fontSize:"28px", color: "white"}}>Việc Làm IT Cho Developer "Chất"</h2>
        </Col>
        <Col span={24} md={16}>
        ...
        <Col span={12} md={4}>
          <Button
            type="primary"
            style={{width:"180px",height:"65px", backgroundColor:"#ff0000", fontSize:"20px"}}
            onClick={() => {
              form.submit();
            }}
          >
