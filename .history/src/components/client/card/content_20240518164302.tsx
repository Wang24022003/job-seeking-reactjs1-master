    ...
    <section className={`${styles['hire-the-best-it-container']} ${styles['bg-gradient-search']}`}>
      <div className={`icontainer ${styles['d-lg-flex']} ${styles['align-items-center']} ${styles['flex-row-reverse']} ${styles['ipx-5']} ${styles['ipy-16']} ${styles['ipy-lg-30']}`}>
        <div className={`flex-1 ${styles['ips-lg-20']}`}>
          <img alt="hide-the-best-it" style={{width:"100% !important"}} src="https://itviec.com/assets/employer_landing/hire-the-best-it-15-95d4b6df6293a405cd77c094b8c7eb5dcc99cf8711f5b47751c841cfa51023a0.png" />
        </div>
