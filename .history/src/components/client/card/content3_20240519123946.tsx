  ...
  return (
    <section className={`${styles['high-value-services-container']} ${styles['ipx-5']} ${styles['ipy-16']} ${styles['ipy-lg-30']}`}>
      <div className={`${styles['icontainer']}`}>
        ...
        <div className={`${styles['bg-white']} ${styles['flex-box-wrapper']} ${styles['ipy-6']} ${styles['ips-lg-12']} ${styles['ipe-lg-12']} ${styles['mt-4']} ${styles['imt-lg-12']} ${styles['ipx-6']} ${styles['ipt-lg-12']} ${styles['ipb-lg-13']}`}>
