...
const HireTheBestITSection = () => {
  return (
    <section className={`${styles['hire-the-best-it-container']} ${styles['bg-gradient-search']}`}>
      <div className={`icontainer ${styles['d-lg-flex']} ${styles['align-items-center']} ${styles['flex-row-reverse']} ${styles['ipx-5']} ${styles['ipy-16']} ${styles['ipy-lg-30']}`}>
        <div className={`flex-1 ${styles['ips-lg-20']} ${styles[`w-100`]}` }>
          <img alt="hide-the-best-it"  src="https://itviec.com/assets/employer_landing/hire-the-best-it-15-95d4b6df6293a405cd77c094b8c7eb5dcc99cf8711f5b47751c841cfa51023a0.png" />
        </div>
        <div className={`flex-1 ${styles['text-it-white']} ${styles['left-box']}`}>
          <div className={styles['left-box-content']}>
            ...
            <button className={`ibtn ibtn-lg ibtn-primary  ${styles['contact-now-btn']}`} data-action="click->employer-landing#handleScrollToForm click->employer-landing#addDataLayerHeadline">
              Liên hệ ngay
            </button>
