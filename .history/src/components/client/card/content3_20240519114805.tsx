  ...
  return (
    <section className={`${styles['high-value-services-container']} ${styles['ipx-5']} ${styles['ipy-16']} ${styles['ipy-lg-30']}`}>
      <div className={styles['icontainer']}>
        <div className={`${styles['h1']} ${styles['lg-title']} text-it-white text-center`}>
          Dịch vụ chất lượng cao dành cho Nhà tuyển dụng IT
        </div>

        <div className={`${styles['bg-white']} ${styles['flex-box-wrapper']} ${styles['ipy-6']} ${styles['ips-lg-12']} ${styles['ipe-lg-12']} mt-4 ${styles['imt-lg-12']} ${styles['ipx-6']} ${styles['ipt-lg-12']} ${styles['ipb-lg-13']}`}>
          <div className="d-lg-flex flex-row-reverse align-items-lg-center">
            ...
            <div className="flex-1">
              ...
              <div className={`${styles['imt-8']} d-lg-flex`}>
                <div className={`${styles['job-posting-content-box']} ${styles['p-3']} ${styles['imb-4']} ${styles['ime-lg-4']} flex-1 d-flex`}>
                ...
                <div className={`${styles['job-posting-content-box']} ${styles['p-3']} flex-1 d-flex`}>
        ...
        <div className={`${styles['bg-white']} ${styles['flex-box-wrapper']} ${styles['ipy-6']} ${styles['ips-lg-12']} ${styles['ipe-lg-8']} ${styles['imt-8']} ${styles['ipy-lg-12']} ${styles['ipx-6']} ${styles['ipt-lg-12']} ${styles['ipb-lg-13']}`}>
          <div className="d-lg-flex align-items-lg-center">
            <div className="d-lg-flex flex-1">
              <img className="w-100 large-pic" src="https://itviec.com/assets/employer_landing/ai-match-15-22d68e502f2d153eec13bae292cf4207d3e90e22ff153b0a28cfcfd26592f75f.png" alt="AI Match" />
            </div>
            <div className="flex-1">
              <div>
                <div className={`${styles['h1']} ${styles['ipy-4']} ${styles['ipy-lg-0']}`}>
                ...
                <div className={`${styles['imt-8']}`}>
                  <div className={`${styles['aim-content-box']} ${styles['p-3']} ${styles['imb-4']} d-flex flex-lg-row align-items-start`}>
                  ...
                  <div className={`${styles['aim-content-box']} ${styles['content-box']} ${styles['p-3']} d-flex flex-lg-row align-items-start`}>
        ...
        <div className={`${styles['bg-white']} ${styles['flex-box-wrapper']} ${styles['ipy-6']} ${styles['ips-lg-12']} ${styles['ipe-lg-8']} ${styles['imt-8']} ${styles['ipx-6']} ${styles['ipy-lg-12']} ${styles['ipt-lg-12']} ${styles['ipb-lg-13']}`}>
          <div className="d-lg-flex flex-row-reverse align-items-lg-center">
            <div className="d-lg-flex justify-content-center">
              <img className="w-100 large-pic" src="https://itviec.com/assets/employer_landing/employer-branding-15-9901407b309ba5b978b453490ba825d6e1c6c82c488649032f98840cd14eed04.png" alt="Employer Branding" />
            </div>
            <div className="flex-1">
              <div className={`${styles['h1']} ${styles['ipy-4']} ${styles['ipy-lg-0']}`}>
              ...
              <div className={`${styles['imt-8']}`}>
                ...
                <div className={`${styles['aim-content-box']} ${styles['p-3']} d-flex flex-lg-row align-items-start`}>
        ...
        <div className={`${styles['imt-8']} ${styles['imt-lg-12']}`}>
          <h3 className={`${styles['text-it-white']} ${styles['ipb-5']} text-center`}>
