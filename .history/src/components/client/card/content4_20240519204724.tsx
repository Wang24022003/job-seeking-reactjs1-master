      ...
      >
        <div className={styles["carousel-inner"]}>
          {feedbacks.map((feedback, index) => (
            ...
            >
              <div className={`d-flex ${styles["carousel-item-wrapper"]}`}>
                <div
                ...
                >
                  ...
                  >
                    <p className={styles["paragraph"]}>{feedback.content}</p>
                  </div>
                  <div
                    className={`d-lg-flex ${styles["justify-content-lg-between"]} ${styles["ipt-lg-8"]}`}
                  >
                    <div>
                      <h3
        ...
        <div
          className={`d-flex ${styles["justify-content-center"]} ${styles["align-items-center"]} ${styles["imt-lg-8"]}`}
        >
          <button
          ...
          >
            <span
              className={`d-flex ${styles["align-items-center"]} ${styles["text-rich-grey"]}`}
            >
          ...
          <span
            className={`mx-3 ${styles["normal-text"]} ${styles["text-rich-grey"]} d-inline-flex`}
          >
