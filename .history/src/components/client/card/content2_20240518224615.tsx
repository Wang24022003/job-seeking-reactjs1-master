  ...
  return (
    <section className=" ${styles['itviec-different-container']}  ${styles['ipt-16']}  ${styles['ipt-lg-30']}  ${styles['ipx-5']}  ${styles['ipx-lg-0']}">
      ...
      <div className=" ${styles['d-lg-flex']}  ${styles['justify-content-center']}  ${styles['align-items-center']}  ${styles['content-wrapper']}  ${styles['ipb-20']}  ${styles['ipt-lg-22']}  ${styles['ipb-lg-30']}  ${styles['ipx-lg-5']}">
        ...
        <div className=" ${styles['content-box']}  ${styles['d-flex']}  ${styles['flex-column']}  ${styles['justify-content-center']}  ${styles['align-items-center']}  ${styles['position-relative']}  ${styles['imt-16']}  ${styles['imt-lg-0']}  ${styles['imx-lg-7']}  ${styles['bg-white']}  ${styles['border-radius-large']}  ${styles['position-relative']} ">
        ...
        <div className="${styles['content-box']}  ${styles['d-flex']}  ${styles['flex-column']}  ${styles['justify-content-center']}  ${styles['align-items-center']}  ${styles['position-relative']}  ${styles['imt-16']} ${styles['imt-lg-0']} ${styles['bg-white']} ${styles['border-radius-large']}  ${styles['position-relative']}">
