...
function ITviecDifferentContainer() {
  return (
    <section className="itviec-different-container ipt-16 ipt-lg-30 ipx-5 ipx-lg-0">
      <div className="text-center">
        <div className="h1 lg-title">
          Điều gì tạo nên sự khác biệt ở ITviec?
        </div>
        <p className="normal-text paragraph ipt-6 ipb-16 ipb-lg-0">
          ITviec là trang tuyển dụng và cơ sở dữ liệu hàng đầu về các chuyên gia IT tại Việt Nam.
        </p>
      </div>
      <div className="d-lg-flex justify-content-center align-items-center content-wrapper ipb-20 ipt-lg-22 ipb-lg-30 ipx-lg-5">
        <div className="content-box d-flex flex-column justify-content-center align-items-center position-relative imt-4 imt-lg-0 bg-white border-radius-large position-relative">
