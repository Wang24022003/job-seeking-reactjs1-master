  ...
  return (
    <section className={'styles["feedback-container"]'}>
      ...
      >
        ...
        <div
          className={`${styles["d-flex"]} ${styles["justify-content-center"]} ${styles["align-items-center"]} ${styles["imt-lg-8"]}`}
        >
          <button
          ...
          >
            <span
              className={`${styles["d-flex"]} ${styles["align-items-center"]} ${styles["text-rich-grey"]}`}
            >
          ...
          <span
            className={`${styles["mx-3"]} ${styles["normal-text"]} ${styles["text-rich-grey"]} ${styles["d-inline-flex"]} `}
          >
