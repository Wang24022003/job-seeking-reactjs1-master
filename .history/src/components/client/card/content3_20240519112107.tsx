...
import './HighValueServices.css'; // Assuming you have a CSS file for styles

const HighValueServices = () => {
  return (
    <section className="high-value-services-container ipx-5 ipy-16 ipy-lg-30">
      <div className="icontainer">
        ...
        <div className="bg-white flex-box-wrapper ipy-6 ips-lg-12 ipe-lg-8 imt-8 ipy-lg-12 ipx-6 ipt-lg-12 ipb-lg-13">
          <div className="d-lg-flex align-items-lg-center">
            ...
            <div className="flex-1">
              <div>
                ...
                <div className="imt-8">
                  <div className="aim-content-box p-3 imb-4 d-flex flex-lg-row align-items-start">
                    ...
                    <p className="ims-4 paragraph">
                      Các ứng viên phù hợp nhất được lựa chọn dựa trên kỹ năng, kinh nghiệm, nhu cầu công việc và hơn thế nữa
                    </p>
                  </div>
                  <div className="aim-content-box content-box p-3 d-flex flex-lg-row align-items-start">
                ...
                <div className="ipt-6">
                  <a className="ibtn ibtn-md ibtn-primary w-100 contact-now-btn fw-500" href="/ai-match?itm_campaign=ai_match&amp;itm_medium=service&amp;itm_source=employer_page_vi">Xem thêm về AI Match</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white flex-box-wrapper ipy-6 ips-lg-12 ipe-lg-8 imt-8 ipx-6 ipy-lg-12 ipt-lg-12 ipb-lg-13">
          <div className="d-lg-flex flex-row-reverse align-items-lg-center">
            ...
            <div className="flex-1">
              ...
              <div className="imt-8">
                <div className="aim-content-box p-3 imb-4 d-flex flex-lg-row align-items-start">
                  ...
                  <div className="ims-4">
                    <p className="normal-text fw-600">
                      Nhà tuyển dụng hàng đầu
                    </p>
                    <p className="imt-2 text-rich-grey">
                      Xuất hiện với vị trí công ty IT nổi bật hàng đầu tại Việt Nam
                    </p>
                  </div>
                </div>
                <div className="aim-content-box p-3 d-flex flex-lg-row align-items-start">
        ...
        <div className="imt-8 imt-lg-12">
          <h3 className="text-it-white ipb-5 text-center">
            Trải nghiệm dịch vụ của ITviec ngay hôm nay
          </h3>
          <div className="d-flex justify-content-center">
            <button className="ibtn ibtn-lg ibtn-primary w-100 contact-now-btn" onClick={() => window.location.href='#contact-form'}>
              Liên hệ ngay
            </button>
          </div>
        </div>
